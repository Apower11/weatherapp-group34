...
//var Iphone = React.createClass({
	...
	render() {
		...
		if(this.state.displayModal){
			modal = <Modal class="tablet-modal" onTablet={true} closeModal={this.closeModal} addTimestamp={this.addTimestamp} />
		}
			...
			<div class={ style.main_container }>
				...
				<div class="timeline">
					{this.state.weatherTimeline.map((item,index) => {
  					...
  					<span onClick={this.openModal} class="material-symbols-outlined add-timestamp-button-tablet">add</span>
				</div>
